...
//		rowModel.getRow(row).setCellEditor( this );
	...
	public Component getTableCellEditorComponent(
		JTable table, Object value, boolean isSelected, int row, int column) //her er int row fra f�r!
	{
		if (value == null)
		{
			editButton.setText( "" );
...
//
	public Component getTableCellRendererComponent(
		JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) //her var det row fra f�r :O
	{
		if (isSelected)
		{
